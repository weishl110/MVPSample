...
//            e.printStackTrace();
     ...
     * 结束所有Activity
     */
    private static final String TAG = "debug_AppManager";

    public void finishAllActivity() {
        Log.e(TAG, "finishAllActivity: size = " + activityStack.toString());
